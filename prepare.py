...
parser.add_argument('--VeRi', action='store_true', default = True, help='prepare dataset VeRi')
...
if opt.VeRi:
    save_path = "./dataset/VeRi_prepare/"
else:
...
# # ================================================================================================
# # market1501_rename(generate frames according to sequences that vehicles do not have)
# # ================================================================================================

# def parse_frame(imgname, dict_cam_seq_max={}):
#     dict_cam_seq_max = {
#         #ab: 第a个camera的第b个sequence
#         #每个数的确定，应该是找到每个camera每段sequence最大frame数确定的，为了之后的时空模型
...
#     path = "./dataset/VeRi_prepare/train_all/"
#     folderName = []
...
#         if not os.path.exists("./dataset/VeRi_rename/train_all/" + fname):
#             os.makedirs("./dataset/VeRi_rename/train_all/" + fname)
...
#             dstfile = "./dataset/VeRi_rename/train_all/" + fname + "/" + newname
#             shutil.copyfile(srcfile, dstfile)
#             # break  # 测试一个id


# def gen_train_rename():
#     path = "./dataset/VeRi_prepare/train/"
#     folderName = []
#     for root, dirs, files in os.walk(path):
#         folderName = dirs
#         break
...
#         if not os.path.exists("./dataset/VeRi_rename/train/" + fname):
#             os.makedirs("./dataset/VeRi_rename/train/" + fname)
...
#             # print(newname)
#             srcfile = path + fname + "/" + imgname
#             dstfile = "./dataset/VeRi_rename/train/" + fname + "/" + newname
#             shutil.copyfile(srcfile, dstfile)
#             # break  # 测试一个id


# def gen_val_rename():
#     path = "./dataset/VeRi_prepare/val/"
#     folderName = []
#     for root, dirs, files in os.walk(path):
#         folderName = dirs
#         break
...
#         if not os.path.exists("./dataset/VeRi_rename/val/" + fname):
#             os.makedirs("./dataset/VeRi_rename/val/" + fname)
...
#             # print(newname)
#             srcfile = path + fname + "/" + imgname
#             dstfile = "./dataset/VeRi_rename/val/" + fname + "/" + newname
#             shutil.copyfile(srcfile, dstfile)
#             # break  # 测试一个id


# def gen_query_rename():
#     path = "./dataset/VeRi_prepare/query/"
#     folderName = []
#     for root, dirs, files in os.walk(path):
#         folderName = dirs
#         break
...
#         if not os.path.exists("./dataset/VeRi_rename/query/" + fname):
#             os.makedirs("./dataset/VeRi_rename/query/" + fname)
...
#             # print(newname)
#             srcfile = path + fname + "/" + imgname
#             dstfile = "./dataset/VeRi_rename/query/" + fname + "/" + newname
#             shutil.copyfile(srcfile, dstfile)
#             # break  # 测试一个id


# def gen_gallery_rename():
#     path = "./dataset/VeRi_prepare/gallery/"
#     folderName = []
#     for root, dirs, files in os.walk(path):
#         folderName = dirs
#         break
...
#         if not os.path.exists("./dataset/VeRi_rename/gallery/" + fname):
#             os.makedirs("./dataset/VeRi_rename/gallery/" + fname)
...
#             # print(newname)
#             srcfile = path + fname + "/" + imgname
#             dstfile = "./dataset/VeRi_rename/gallery/" + fname + "/" + newname
#             shutil.copyfile(srcfile, dstfile)
#             # break  # 测试一个id
...
#     gen_query_rename()
#     gen_gallery_rename()
#     shutil.rmtree("./dataset/VeRi_prepare/")
#     print("Done!")
